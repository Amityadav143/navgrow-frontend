...
import { Newspaper, Settings, Image, Briefcase, LayoutDashboard, ChevronRight, Globe, Menu, X } from 'lucide-react';
    ...
    <div className="flex min-h-screen bg-gray-950">
      ...
      {mobileNavOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <aside className="absolute left-0 top-0 h-full w-64 max-w-[80vw] bg-gray-900 text-gray-300 flex flex-col shadow-2xl">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="lg:hidden sticky top-0 z-40 flex items-center gap-3 px-4 h-14 bg-gray-900 border-b border-gray-800">
          ...
          <span className="text-xs text-amber-400 font-bold ml-auto">Editor</span>
        </header>
