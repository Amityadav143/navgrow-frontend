...
const FAQS = [
  ...
  { q: 'Does Navgrow work outside the railway sector?', a: 'Yes. While we are specialists in Indian Railways, we also serve industrial manufacturing plants, civil construction projects, government and PSU clients, utility companies, and private sector organisations across India. Our engineering competencies apply broadly.' },
  { q: 'What are your payment terms for engineering projects?', a: 'Standard payment terms are 30% advance, 40% at milestone, 30% on completion. For government clients, we follow GeM/CPPP/IREPS payment schedules. For products, payment via UPI, bank transfer, or Razorpay at checkout.' },
  { q: 'Do you offer Annual Maintenance Contracts (AMC)?', a: 'Yes. Our AMC packages cover scheduled preventive maintenance, priority emergency response (48–72 hours), periodic safety audits, and monthly reporting. AMC rates start from ₹60,000/year depending on scope and equipment type.' },
  { q: 'Where is Navgrow based and which areas do you serve?', a: 'Navgrow is headquartered in Siliguri, West Bengal (734001). We primarily serve North Bengal, North-East India, and NER Zone railway projects. For large contracts, we can mobilise pan-India. Products are shipped anywhere in India.' },
];
